...
def get_data():
    # Load the data
    data = pd.read_csv('../../0_data/1_intermediate_ML/selected_features_one_hot_complexity_16_continuous_demanding_oneformerDriving_crash.csv')
    features = {
...
def main():
    ...
    plt.legend()
    plt.savefig('modeling_classification_crash_nn_16_continuous_on_oneformerDriving.png')
